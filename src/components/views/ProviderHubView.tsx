  ...
  return (
    <div className="p-4 space-y-4">
      ...
      <div className="bg-card border border-border rounded-lg p-4">
        <h2 className="text-xs font-semibold text-foreground mb-2">{t("ph.routing")}</h2>
        <div className="space-y-1.5 text-xs text-muted-foreground">
          <div className="flex justify-between"><span>{t("ph.code_gen")}</span><span className="font-mono text-foreground">Anthropic → OpenAI</span></div>
          <div className="flex justify-between"><span>{t("ph.planning")}</span><span className="font-mono text-foreground">Anthropic → DeepSeek</span></div>
          <div className="flex justify-between"><span>{t("ph.quick")}</span><span className="font-mono text-foreground">OpenAI (gpt-4o-mini)</span></div>
          <div className="flex justify-between"><span>{t("ph.privacy")}</span><span className="font-mono text-foreground">Ollama via VPS</span></div>
        </div>
      </div>
    </div>
  );
