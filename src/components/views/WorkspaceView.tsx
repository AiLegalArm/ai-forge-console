  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        {/* Side rail — compact pipeline/graph */}
    ...
    <div className="p-2.5 space-y-3 text-xs">
      <div>
        <div className="flex items-center justify-between mb-1.5">
          <span className="text-[10px] font-mono font-semibold text-foreground uppercase tracking-wider">Pipeline</span>
      ...
      <div>
        <span className="text-[10px] font-mono font-semibold text-foreground uppercase tracking-wider">Checkpoints</span>
      ...
      <div>
        <span className="text-[10px] font-mono font-semibold text-foreground uppercase tracking-wider">Memory</span>
        <div className="mt-1.5 space-y-0.5 text-[10px]">
          <div className="flex justify-between text-muted-foreground"><span>Snapshots</span><span className="text-foreground font-mono">7</span></div>
          <div className="flex justify-between text-muted-foreground"><span>Context</span><span className="text-foreground font-mono">48K tok</span></div>
          <div className="flex justify-between text-muted-foreground"><span>AGENTS.md</span><span className="text-success font-mono">Synced</span></div>
        </div>
      </div>
    </div>
  );
