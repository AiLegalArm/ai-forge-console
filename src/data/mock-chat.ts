...
export const mockChatSessions: ChatSession[] = [
  ...
  },
  {
    ...
    isActive: true,
    providerMeta: { provider: "OpenRouter", model: "openai/gpt-4.1", backend: "hybrid", routingKey: "code_heavy" },
    linked: { taskId: "task-rbac", subtaskId: "task-rbac-exec", taskTitle: "Build user management module", agentId: "agent-frontend", agentName: "Frontend Agent", executionContextId: "exec-impl-rbac-1" },
    lastMessageAtIso: now,
    unreadCount: 2,
  },
  {
    ...
    linked: { taskId: "task-rbac", subtaskId: "task-rbac-audit", taskTitle: "Build user management module", auditFindingId: "AF-SEC-014", auditFindingTitle: "Invite endpoint permission scope too broad", executionContextId: "exec-audit-rbac-1" },
    lastMessageAtIso: now,
    unreadCount: 1,
  },
  {
    ...
    isActive: true,
    providerMeta: { provider: "OpenRouter", model: "openai/o3", backend: "cloud", routingKey: "release_critical" },
    linked: { taskId: "task-rbac", subtaskId: "task-rbac-release", taskTitle: "Build user management module", executionContextId: "exec-release-rbac-1" },
    lastMessageAtIso: now,
    unreadCount: 0,
  },
];
...
const messages: ChatMessage[] = [
  ...
  },
  {
    ...
    linked: {
      ...
      executionContextId: "exec-audit-rbac-1",
    },
  },
  {
    id: "au2",
...
export const initialChatState: ChatState = {
  ...
  relatedContextBySessionId: {
    ...
    "agent-session-1": { taskId: "task-rbac", subtaskId: "task-rbac-exec", taskTitle: "Build user management module", agentId: "agent-frontend", agentName: "Frontend Agent", executionContextId: "exec-impl-rbac-1" },
    "audit-session-1": { taskId: "task-rbac", subtaskId: "task-rbac-audit", taskTitle: "Build user management module", auditFindingId: "AF-SEC-014", auditFindingTitle: "Invite endpoint permission scope too broad", executionContextId: "exec-audit-rbac-1" },
    "review-session-1": { taskId: "task-rbac", subtaskId: "task-rbac-release", taskTitle: "Build user management module", executionContextId: "exec-release-rbac-1" },
  },
};
...
export const activeAgents = [
  {
    ...
    task: "Coordinating delegation rollup",
    provider: "Ollama",
